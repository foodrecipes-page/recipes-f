...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'f'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-f@main/recipes/<cuisine>/<diet>/<slug>.json
```
